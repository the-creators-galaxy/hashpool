...
public class TransactionInfo
{
    ...
    /// <summary>
    /// The list of public keys that have signed this transaction.
    /// </summary>
    [JsonPropertyName("signed_by")]
    public string[] SignedBy { get; set; }
    /// <summary>
    /// The history of actions taken on this transaction, including 
    /// creation, signing and submission.
    /// </summary>
    [JsonPropertyName("history")]
    public TransactionHistoryInfo[] History { get; set; }
}
